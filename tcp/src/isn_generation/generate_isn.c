...
uint32_t generate_isn(tcp_stack *stack, internal_tcp_socket local_socket,
  ...
  md5_result hash_result =
      md5(stack->md5_algorithm, local_socket.host_order_ipv4_addr,
          local_socket.host_order_port, remote_socket.host_order_ipv4_addr,
          remote_socket.host_order_port, secret_key, secret_key_len);
